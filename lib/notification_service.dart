...
//
//
//  Future<void> intialiseNotifications() async{
//
//
...
class NotificationServices {
  ...
  Future<void> showNotification(RemoteMessage message)async{
    ...
    AndroidNotificationDetails androidNotificationDetails = AndroidNotificationDetails(
        ...
        sound: channel.sound,
        actions: [
          const AndroidNotificationAction("1 ", "receive",titleColor: Colors.green,showsUserInterface: true, cancelNotification: true),
